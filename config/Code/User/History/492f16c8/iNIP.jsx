        ...
        return (
            <div>
                <div className="sticky top-0 h-screen ">
                    ...
                    <div className='flex w-full justify-around h-3/5 items-center'>
                        <div>imagenes</div>
                        <div className=''>
                            <p>Descubre nuestras invitaciones digitales, la elegancia que tu boda merece.</p>  
                        </div>
                    </div>
                    <div className='flex items-center h-2/5'>
                        <p>Invitaciones únicas para bodas inolvidables. Descubre nuestra magia y crea recuerdos que durarán toda la vida.</p>
                    </div>
                </div>
