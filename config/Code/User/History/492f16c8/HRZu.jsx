                    ...
                    <nav className=' bg-Mantle p-4'>
                        <div className='container mx-auto flex justify-between items-center'>
                            ...
                            <div className='hidden lg:flex space-x-4'>
                                <a href="" className=' bg-Lavender text-Mantle font-semibold cursor-zoom-in'>opcion 1</a>
                                <a href="" className=' bg-Blue text-Mantle font-semibold'>opcion 2</a>
                                <a href="" className=' bg-Sapphire text-Mantle font-semibold'>opcion 3</a>
                            </div>
