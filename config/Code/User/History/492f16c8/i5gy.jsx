                    ...
                    <nav className=' bg-Crust p-4'>
                        <div className='container mx-auto flex justify-between items-center'>
                            ...
                            <div className='hidden lg:flex space-x-4'>
                                <div  className='flex'>
                                    <svg className="bg-Yellow" viewBox="0 0 1300 3179" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px"><path d="M0 2725L1200 19v2706H0zm1200 0V19h100v2706h-100z" /></svg>
                                    <a href="">Inicio</a>
