                    ...
                    <nav className=' bg-Crust p-4'>
                        <div className='container mx-auto flex justify-between items-center'>
                            ...
                            <div className='hidden lg:flex space-x-4'>
                                <a href="" className=' bg-Yellow text-Mantle text-xl font-semibold hover:underline transform hover:scale-110 transition duration-300 ease-in-out'>
                                <svg viewBox="0 0 1300 3179" xmlns="http://www.w3.org/2000/svg"><path d="M0 2725L1200 19v2706H0zm1200 0V19h100v2706h-100z"/></svg>
                                    Inicio
                                <svg viewBox="0 0 1300 3179" xmlns="http://www.w3.org/2000/svg"><path d="M100 2725V19h1200L100 2725zm0 0H0V19h100v2706z"/></svg>
                                </a>
